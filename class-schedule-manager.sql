CREATE TABLE "public.Teacher" (
	...
	CONSTRAINT "Teacher_pk" PRIMARY KEY ("id","registration")
) WITH (
  OIDS=FALSE
);
...
CREATE TABLE "public.Student" (
	...
	"profile_photo" varchar NOT NULL,
	"class_id" integer NOT NULL,
	CONSTRAINT "Student_pk" PRIMARY KEY ("id","registration")
) WITH (
  OIDS=FALSE
);
...
CREATE TABLE "public.StudentAssociation" (
	"id" serial NOT NULL,
...
CREATE TABLE "public.ClassCanceled" (
	"id" serial NOT NULL,
...
CREATE TABLE "public.TeachTemporarily" (
	"id" serial NOT NULL,
	"schedule_id" integer NOT NULL,
	"quantity" integer NOT NULL,
	"date" DATE NOT NULL,
...
CREATE TABLE "public.StudentAlerts" (
	"id" serial NOT NULL,
	"discipline_id" integer NOT NULL,
	"student_id" integer NOT NULL,
...
CREATE TABLE "public.CouseDiscipline" (
	"id" serial NOT NULL,
	"discipline_id" integer NOT NULL,
	"course_id" integer NOT NULL,
...
CREATE TABLE "public.SubstituteTeachers" (
	"id" serial NOT NULL,
	"teacher_id" integer NOT NULL,
